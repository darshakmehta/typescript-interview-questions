...
See also [Why Can’t I Access A Protected Member From A Derived Class?](https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/classes-and-structs/protected-members) which explains more of C#‘s reasoning on the same topic.
